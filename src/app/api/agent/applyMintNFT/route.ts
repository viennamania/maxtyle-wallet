  ...
  */
  ...
  if (user) {
    ...
    if (mobile && mobile.length > 10) {
      ...
      try {
        ...
        const msgBody = `[MKRW] [TID:#${applicationId}] You have a new agent application from [${userName}]`;
  ...
  if (userPhoneNumber && userPhoneNumber.length > 10) {
    ...
    try {
      ...
      const msgBody = `[MKRW] [TID:#${applicationId}] Your master bot application has been submitted successfully!`;
